...
public class Handlewait {
	...
	public void waitfornextelemet(WebDriverWait wait, By buttondisable, By spinnerLocator)
	{
	...
	public WebElement  waitforelementvisible(WebDriverWait wait,By element,WebDriver driver)
	{
